          ...
          <Grid container spacing={2}>
            ...
            <Grid item sm={4} md={4}>
              <div className='photo-img-wrapper'>
                ...
                {
                  panImage !== "" ? (
                    <Card sx={{ borderRadius: 0,  marginTop: "15px", cursor: "pointer" }} onClick={() => _handleView(panImage)}>
...
export default connect(mapStateProps, { GET_STUDENT_MASTER, UPLOAD_FILES, ADD_PERENTS_DETAILS, STUDENT_ID })(FatherForm)
